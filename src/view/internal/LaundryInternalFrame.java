   ...
   private void initComponents() {
      ...
      panelMenuLaundryLayout.setHorizontalGroup(
         ...
         .addGroup(panelMenuLaundryLayout.createSequentialGroup()
            .addContainerGap()
            .addComponent(menuLaundry, javax.swing.GroupLayout.DEFAULT_SIZE, 871, Short.MAX_VALUE)
            .addContainerGap())
      );
      panelMenuLaundryLayout.setVerticalGroup(
         ...
         .addGroup(panelMenuLaundryLayout.createSequentialGroup()
            .addContainerGap()
            .addComponent(menuLaundry, javax.swing.GroupLayout.DEFAULT_SIZE, 532, Short.MAX_VALUE)
            .addContainerGap())
      );

      getContentPane().add(panelMenuLaundry, java.awt.BorderLayout.CENTER);
